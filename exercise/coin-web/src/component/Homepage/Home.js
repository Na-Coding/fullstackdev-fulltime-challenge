...
import { Row, Col, Table, Button, DropdownItem, Collapse, Navbar, NavbarToggler, NavbarBrand, Nav, NavItem, NavLink } from 'reactstrap';
...
export default class Home extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            coin: 0,
            message: [],
            sent_socket: "https://coin-api-v2.herokuapp.com"
        }
    }
    ...
    user_logout =  () => {
        ...
        // try {
        //     await get("user/user_logout").then(res => {
        //         if (res.success) {
            ...
            <div >
                <Navbar color="faded" light>
                    ...
                    <Collapse isOpen={!this.state.collapsed} navbar>
                        <Nav navbar>
                            <NavItem >
                                <NavLink onClick={this.user_logout} style={{ cursor: 'pointer', fontWeight: 'bold', textAlign: 'right', fontSize: 25, paddingRight: 15, paddingTop: 20 }}>Logout</NavLink>
                            </NavItem>
                        </Nav>
                    </Collapse>
                </Navbar>
                <div className="font-h-home" >
